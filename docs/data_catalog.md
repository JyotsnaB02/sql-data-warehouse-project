...
maintenance_required	NVARCHAR(50)	Indiactes whether the product requires maintenance(e.g.,’yes’,’No’)
...
3.gold.fact_sales
•	Purpose:   Stores transactional sales data for analytical puposes.
•	Columns:
Column Name	Data Type	Description
order_number	NVARCHAR(50)	A unique alphanumeric identifier for each sales order(e.g:’SOS4496’)
product_key	INT	Surrogate key linking the order to the product dimension  table.
customer_key	INT	Surrogate key liking the order to the customer dimension.
...
price	INT	The price per unit of th e product for the line item,in whole currency units(e.g.,25)
